...
def get_mongo_client(uri: Optional[str] = None) -> MongoClient:
    ...
    if uri:
        ...
        if app_name_param:
            uri = f"mongodb+srv://{encoded_username}:{encoded_password}@{cluster_url}/?retryWrites=true&w=majority&appName={app_name_param}"
        else:
            uri = f"mongodb+srv://{encoded_username}:{encoded_password}@{cluster_url}/?retryWrites=true&w=majority"
