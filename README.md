...
5. **Pinecone Setup:**
   ...
   - Add to your `.env` file:
     ...
     EMBEDDING_DIMENSION=384                # Matches text-embedding-3-small
     ```
   - The index will be automatically created if it doesn't exist (384 dimensions for text-embedding-3-small)
...
- `values`: Embedding vector (384 dimensions)
...
**Notes:**
- The Pinecone index is automatically created if it doesn't exist (384 dimensions, cosine similarity)
...
- `EMBEDDING_DIMENSION`: Pinecone index dimension (default: `384` for text-embedding-3-small)
...
- The index is automatically created if it doesn't exist (384 dimensions, cosine similarity)
